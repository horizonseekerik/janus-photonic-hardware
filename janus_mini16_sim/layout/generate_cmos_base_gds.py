...
def build_cmos_base_tile(tile_id: int = 0) -> gf.Component:
    ...
    matching the 6.25 mm^2 top optical tile footprint):
      ...
      8. Local Power Grid & Clock H-Tree distribution
    """
    tile = gf.Component()
    tile_w = 600.0
    tile_h = 600.0
    ...
    # 8. Local Power Grid Mesh (Top Metal 71/0: VDD / VSS Stripes)
    for p in range(7):
        yp = 30.0 + p * 85.0
    ...
    # 9. 3.125 GHz Balanced Clock Tree Trunk (Metal 6: Layer 61/0)
