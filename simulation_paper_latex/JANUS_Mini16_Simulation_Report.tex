...
\midrule
\textbf{Total Path Attenuation} & $\mathbf{-50.34\,\mathrm{dB}}$ \\
\textbf{Delivered Power at APD ($P_{\mathrm{rx}}$)} & $\mathbf{-16.90\,\mathrm{dBm}}$ ($20.42\,\mu\mathrm{W}$) \\
$\mathrm{SAC^2M}$ APD Dynamic Threshold Power ($Q=9.38$, jitter) & $-23.04\,\mathrm{dBm}$ ($4.96\,\mu\mathrm{W}$) \\
\midrule
\textbf{Net Operating Link Margin} & $\mathbf{+6.142\,\mathrm{dB}}$ \\
\bottomrule
\end{tabularx}
\end{table}
